...
class Secu{
	...
	public function secuteszt(){
		//echo("SECU tesztje sikeres");
	}
	...
	public function cleanVar($str){
		if(is_numeric($str)){
			$v = intval(strip_tags(trim($str)));
		}
		else{
			$str_s = strip_tags(trim($str));
			$v = $this->xss_clean($str_s);
		}
