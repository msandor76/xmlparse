...
class Url
{
     ...
     * templatePath($custom = TEMPLATE, $folder = '/assets/')
     */
    public static function templatePath($custom = TEMPLATE, $folder = '/')
    {
        $template = Inflector::tableize($custom);

        return SITEURL .'templates/' .$template .$folder; //   return TEMPLATE_DIR .'templates/' .$template .$folder;
    }
     ...
     * relativeTemplatePath($custom = TEMPLATE, $folder = '/assets/')
     */
    public static function relativeTemplatePath($custom = TEMPLATE, $folder = '/')
    {
